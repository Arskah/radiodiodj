...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- |
| 1   | **Shared listing rules** (refactor). Move the root listing, `should_rescan` and the gone rule out of `scan_all` into one module, with mtimes in the listing. `scanner.rs` tests pass **unmodified**.                                                                                 | —          |
