...
| [key.md](./key.md)                             | How the musical key is measured, and why Camelot is presentation.                       |
| [audio-measure.md](./audio-measure.md)         | The measurement library inside the app, and what it may not depend on.                  |
